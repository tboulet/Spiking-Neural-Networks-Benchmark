from datasets import cifar10_repeat_dataloaders
from config_snn_repeat_cifar10 import Config
...
train_loader, valid_loader, test_loader = cifar10_repeat_dataloaders(config)
