from datasets import cifar10_line_dataloaders
from config_snn_cifar10_line import Config
...
train_loader, valid_loader, test_loader = cifar10_line_dataloaders(config)
